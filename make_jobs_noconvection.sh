...
# job names / labels:
JOBS_NAME[0]='events_noconvection'
...
OUT_HEIGHTS[0]='15,50,100,250,750,1000,2000,4000,7000,10000'
...
TEMPL_DIR=/nobackup/eehgu/everest-flexpart/templates/events_noconvection
