...
# Save plot
save_loc = base_dir + 'out_figures/AllEvents_traj_%s.png'%pressure
...
#cb1 = plt.colorbar(contour_plot1, ax=ax1, shrink=0.8)
#cb1.ax.set_ylabel('Emission sensitivity (%)')
ax1.set_title('JJAS, n=%s, end level = %s hPa'%(len(JJAS_cubes),pressure))

fig.tight_layout()


# Save plot
save_loc = base_dir + 'out_figures/JJAS_traj_%s.png'%pressure 
...
#cb1 = plt.colorbar(contour_plot1, ax=ax1, shrink=0.8)
#cb1.ax.set_ylabel('Emission sensitivity (%)')
ax1.set_title('DJF, n=%s, end level = %s hPa'%(len(DJF_cubes),pressure))

fig.tight_layout()


# Save plot
save_loc = base_dir + 'out_figures/DJF_traj_%s.png'%pressure
...
#cb1 = plt.colorbar(contour_plot1, ax=ax1, shrink=0.8)
#cb1.ax.set_ylabel('Emission sensitivity (%)')
ax1.set_title('ON, n=%s, end level = %s hPa'%(len(ON_cubes),pressure))

fig.tight_layout()


# Save plot
save_loc = base_dir + 'out_figures/ON_traj_%s.png'%pressure
...
#cb1 = plt.colorbar(contour_plot1, ax=ax1, shrink=0.8)
#cb1.ax.set_ylabel('Emission sensitivity (%)')
ax1.set_title('M, n=%s, end level = %s hPa'%(len(M_cubes),pressure))

fig.tight_layout()


# Save plot
save_loc = base_dir + 'out_figures/M_traj_%s.png'%pressure
